...
// Import constants
import {AERODROME_ROUTER, UNISWAP_V2_ROUTER, UNISWAP_V4_ROUTER, UNISWAP_V4_QUOTER} from "../src/Constants.sol";
...
contract SwapAggregatorTest is Test {
    ...
    function setUp() public {
        ...
        swapAggregator = new SwapAggregator(AERODROME_ROUTER, UNISWAP_V2_ROUTER, UNISWAP_V4_ROUTER, UNISWAP_V4_QUOTER);

        // Deploy MockSwapAggregator for controlled testing
        mockSwapAggregator =
            new MockSwapAggregator(AERODROME_ROUTER, UNISWAP_V2_ROUTER, UNISWAP_V4_ROUTER, UNISWAP_V4_QUOTER);
